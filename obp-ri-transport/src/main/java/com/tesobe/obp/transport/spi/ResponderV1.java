 ...
 * @since 2016.0
 */
@SuppressWarnings("WeakerAccess") public abstract class ResponderV1
  implements Receiver
{
  public ResponderV1(Decoder d, Encoder e)
  {
    assert d != null;
    assert e != null;
  ...
  static final Map<String, BiFunction<Decoder.Request, Encoder, String>> api
    = new HashMap<>();
  static final Logger log = LoggerFactory.getLogger(ResponderV1.class);
}
